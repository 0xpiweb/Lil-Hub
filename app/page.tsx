...
export default async function Dashboard() {
  ...
  const btnBase = 'inline-flex items-center gap-1.5 px-4 h-10 rounded-full text-sm font-medium border transition-colors [box-sizing:border-box] will-change-transform [transform:translateZ(0)]';
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">
            <div className="relative flex-shrink-0">
              <div className="absolute inset-0 rounded-full pointer-events-none" style={{
                background: 'radial-gradient(circle, rgba(161,0,255,0.4) 0%, rgba(161,0,255,0) 70%)',
                filter: 'blur(8px)',
                transform: 'scale(1.8)',
              }} />
              <div className="h-10 w-10 min-w-[40px] rounded-full bg-white overflow-hidden flex items-center justify-center relative">
          ...
          <p className="text-zinc-400 mt-1 text-sm flex items-center gap-2 flex-wrap">
            <span>Total Supply: <span className="font-bold" style={{ color: '#A100FF' }}>1,350,000,000 $LIL</span></span>
          ...
          return (
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-4 transition-all duration-300 ease-in-out hover:border-[#A100FF] hover:shadow-[0_0_15px_rgba(161,0,255,0.4)]">
              <div className="flex flex-wrap items-center gap-2 mb-8">
                <span className="text-lg font-bold tracking-tight leading-none" style={{ color: '#A100FF' }}>
      ...
      <footer className="border-t border-white/5 bg-white/[0.03] pt-4 pb-6">
        <p className="text-center text-zinc-600 text-[10px] font-bold uppercase tracking-widest mb-5">The Moat Ecosystem</p>
        <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="https://freak-hub.vercel.app"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs font-medium transition-all duration-200 hover:scale-105 hover:border-white/40 hover:bg-white/15"
          >
